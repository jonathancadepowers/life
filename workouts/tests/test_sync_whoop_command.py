...
class TestSyncWhoopCommand(TestCase):
        ...
        self.sample_workout_data = [
            {
                ...
                "sport_id": 63,  # Running
                "score": {"average_heart_rate": 150, "max_heart_rate": 180, "kilojoule": 2000},  # ~478 calories
            },
            {
                "id": "workout_456",
                ...
                "sport_id": 48,  # Cycling
                "score": {"average_heart_rate": 140, "max_heart_rate": 170, "kilojoule": 3000},  # ~717 calories
            },
        ]
    ...
    def test_sync_returns_error_result_on_auth_failure(self, mock_client_class):
        ...
        mock_client_instance.get_all_workouts.side_effect = ValueError(
            "Whoop refresh token expired or invalid. Please re-authenticate by running: " "python manage.py whoop_auth"
        )
        ...
        workout_data = [
            {
                ...
                "end": "2025-10-27T13:00:00.000Z",
                "sport_id": 63,
                "score": {"average_heart_rate": 150, "max_heart_rate": 180, "kilojoule": 4184},  # Exactly 1000 calories
            }
        ]

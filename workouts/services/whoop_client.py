...
class WhoopAPIClient:
    ...
    def __init__(self):
        ...
        if not self.client_id or not self.client_secret:
            raise ValueError("WHOOP_CLIENT_ID and WHOOP_CLIENT_SECRET must be set in environment variables or database")
    ...
    def _make_authenticated_request(self, endpoint: str, method: str = "GET", params: Optional[Dict] = None) -> Dict:
        """
    ...
    def get_workouts(
        ...
        return self._make_authenticated_request("/developer/v2/activity/workout", params=params)
    ...
    def get_all_workouts(
        ...
        while True:
            response = self.get_workouts(start_date=start_date, end_date=end_date, next_token=next_token)

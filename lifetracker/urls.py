...
urlpatterns = [
    ...
    path(
        "settings/inspirations/<int:inspiration_id>/delete/",
        settings_views.delete_inspiration,
    ...
    path(
        "settings/writing-images/<int:image_id>/delete/",
        settings_views.delete_writing_image,
        name="delete_writing_image",
    ),
    ...
    path(
        "settings/habits/<str:column_name>/toggle-abandon/",
        settings_views.toggle_abandon_day,
        name="toggle_abandon_day",
    ),

...
class MonthlyObjective(models.Model):
    ...
    start = models.DateField(help_text="First day of the month for this objective", db_index=True)
    end = models.DateField(help_text="Last day of the month for this objective", db_index=True)
    ...
    label = models.CharField(
        max_length=255, help_text="Name/description of the objective (e.g., '30 Running Workouts')"
    )
    ...
    result = models.FloatField(
        null=True, blank=True, help_text="Actual result value from executing the objective_definition SQL query"
    )

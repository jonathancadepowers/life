...
class DailyAgenda(models.Model):
    ...
    date = models.DateField(help_text="Date for this agenda", db_index=True)
    ...
    target_1 = models.CharField(max_length=255, blank=True, default="", help_text="Target 1 text")
    ...
    target_2 = models.CharField(max_length=255, blank=True, default="", help_text="Target 2 text")
    ...
    target_3 = models.CharField(max_length=255, blank=True, default="", help_text="Target 3 text")

    # Score fields (0 = sad, 0.5 = neutral, 1 = happy)
    target_1_score = models.FloatField(null=True, blank=True, help_text="Score for target 1 (0, 0.5, or 1)")
    target_2_score = models.FloatField(null=True, blank=True, help_text="Score for target 2 (0, 0.5, or 1)")
    target_3_score = models.FloatField(null=True, blank=True, help_text="Score for target 3 (0, 0.5, or 1)")

    # Overall day score (calculated from target scores)
    day_score = models.FloatField(
        null=True, blank=True, help_text="Overall score for the day (0.0 to 1.0, calculated from target scores)"
    )

    # Other plans field (supports markdown)
    other_plans = models.TextField(
        blank=True, default="", help_text="Other plans or notes for the day (supports Markdown)"
    )

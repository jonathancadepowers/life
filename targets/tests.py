...
class ActivityReportViewsTestCase(TestCase):
    ...
    def test_workout_data_aggregation_with_distance(self):
        """Test workout data aggregation showing miles for distance-based sports"""
        ...
        self.assertEqual(running_data['total_miles'], 5.0)
    ...
    def test_workout_data_aggregation_without_distance(self):
        ...
        self.assertEqual(yoga_data['total_miles'], 0)
    ...
    def test_miles_shown_when_distance_available(self):
        """Test that Miles is shown instead of Calories when distance is available"""
        ...
        # Should show Miles for Running
        self.assertIn('Miles', content)

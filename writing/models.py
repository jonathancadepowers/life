...
class BookCover(models.Model):
    ...
    image = CloudinaryField("image", help_text="Book cover image displayed on the writing page")
...
class WritingPageImage(models.Model):
    ...
    image = CloudinaryField("image", help_text="Image file to display on the writing page")
...
class WritingLog(models.Model):
    ...
    source = models.CharField(max_length=50, help_text="Source of the writing log data (e.g., 'Manual', 'Toggl')")
    ...
    duration = models.DecimalField(
        max_digits=4, decimal_places=1, help_text="Duration of writing session in hours", null=True, blank=True
    )

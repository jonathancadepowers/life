...
class APICredentialAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Provider Information", {"fields": ("provider",)}),
        ("API Credentials", {"fields": ("api_token", "workspace_id", "api_url")}),
        ("Additional Metadata", {"fields": ("metadata",), "classes": ("collapse",)}),
    ...
    has_api_token.boolean = True  # type: ignore[attr-defined]
    has_api_token.short_description = "Has API Token"  # type: ignore[attr-defined]
...
class OAuthCredentialAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Provider Information", {"fields": ("provider", "redirect_uri")}),
        ("OAuth Credentials", {"fields": ("client_id", "client_secret")}),
    ...
    has_tokens.boolean = True  # type: ignore[attr-defined]
    has_tokens.short_description = "Has Tokens"  # type: ignore[attr-defined]

...
class LifeTrackerColumnAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Column Information", {"fields": ("id", "column_name", "display_name", "icon", "parent", "tooltip_text")}),
        (
            "Active Period",
            {
        ...
        (
            "SQL Query",
            {
                ...
                "description": (
                    "SQL query to determine if checkbox should appear. " "Available parameters: :day_start, :day_end"
                ),
            },
        ),
        (
    ...
    is_active_status.short_description = "Current Status"  # type: ignore[attr-defined]
...
class SettingAdmin(admin.ModelAdmin):
    ...
    value_preview.short_description = "Value"  # type: ignore[attr-defined]

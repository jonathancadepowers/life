...
class TestTogglAPIClient(TestCase):
    ...
    def test_successful_authentication(self, mock_getenv):
        ...
        mock_getenv.side_effect = lambda key: {"TOGGL_API_TOKEN": "test_api_token", "TOGGL_WORKSPACE_ID": "12345"}.get(
            key
        )
    ...
    def test_make_request_uses_basic_auth(self, mock_request, mock_getenv):
        ...
        mock_getenv.side_effect = lambda key: {"TOGGL_API_TOKEN": "test_token_123", "TOGGL_WORKSPACE_ID": "12345"}.get(
            key
        )
    ...
    def test_http_401_error(self, mock_request, mock_getenv):
        ...
        # Mock: Environment variables
        mock_getenv.side_effect = lambda key: {"TOGGL_API_TOKEN": "invalid_token", "TOGGL_WORKSPACE_ID": "12345"}.get(
            key
        )
    ...
    def test_get_time_entries_success(self, mock_request, mock_post, mock_getenv):
        ...
        # Mock: Environment variables
        mock_getenv.side_effect = lambda key: {"TOGGL_API_TOKEN": "test_token", "TOGGL_WORKSPACE_ID": "12345"}.get(key)
        ...
        mock_post_response.json.return_value = [
            {
                ...
                "tag_ids": [1, 2],
                "time_entries": [
                    {"id": 123456789, "start": "2023-10-25T10:00:00Z", "stop": "2023-10-25T12:00:00Z", "seconds": 7200}
                ],
            }
        ]
        ...
        mock_request_response.json.return_value = [{"id": 1, "name": "coding"}, {"id": 2, "name": "backend"}]
        ...
        entries = client.get_time_entries(start_date=datetime(2023, 10, 1), end_date=datetime(2023, 10, 31))
    ...
    def test_get_projects_success(self, mock_request, mock_getenv):
        ...
        mock_response = mock.Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = [{"id": 100, "name": "Project Alpha"}, {"id": 200, "name": "Project Beta"}]
        mock_request.return_value = mock_response
    ...
    def test_get_projects_missing_workspace_id(self, mock_getenv):
        ...
        mock_getenv.side_effect = lambda key: {"TOGGL_API_TOKEN": "test_token", "TOGGL_WORKSPACE_ID": None}.get(key)

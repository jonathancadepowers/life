...
class NutritionAPITestCase(TestCase):
    ...
    def test_log_nutrition_success(self):
        ...
        data = {"calories": "500", "fat": "20", "carbs": "50", "protein": "30", "date": "2025-10-28"}

        response = self.client.post(reverse("nutrition:log_nutrition"), data=data)
    ...
    def test_log_nutrition_with_decimal_values(self):
        ...
        data = {"calories": "523.5", "fat": "22.8", "carbs": "45.2", "protein": "35.1", "date": "2025-10-28"}
    ...
    def test_log_nutrition_non_numeric_value(self):
        ...
        data = {"calories": "abc", "fat": "20", "carbs": "50", "protein": "30", "date": "2025-10-28"}  # Invalid
    ...
    def test_log_nutrition_negative_value(self):
        ...
        data = {"calories": "-100", "fat": "20", "carbs": "50", "protein": "30", "date": "2025-10-28"}  # Negative
    ...
    def test_log_nutrition_invalid_date_format(self):
        ...
        data = {"calories": "500", "fat": "20", "carbs": "50", "protein": "30", "date": "invalid-date"}
    ...
    def test_log_nutrition_with_utc_date(self):
        ...
        data = {"calories": "600", "fat": "25", "carbs": "60", "protein": "40", "date": "2025-10-28"}
    ...
    def test_log_nutrition_with_zero_values(self):
        ...
        data = {"calories": "0", "fat": "0", "carbs": "0", "protein": "0", "date": "2025-10-28"}
...
class NutritionModelTestCase(TestCase):
    ...
    def test_create_nutrition_entry(self):
        ...
        entry = NutritionEntry.objects.create(
            source="Manual", source_id="test-123", consumption_date=now, calories=500, fat=20, carbs=50, protein=30
        )
    ...
    def test_unique_source_constraint(self):
        ...
        with self.assertRaises(Exception):
            NutritionEntry.objects.create(
                source="Manual", source_id="test-123", consumption_date=now, calories=600, fat=25, carbs=55, protein=35
            )

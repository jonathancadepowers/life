...
class NutritionEntry(models.Model):
    ...
    source = models.CharField(max_length=50, help_text="Source of the nutrition data (e.g., 'Manual', 'MyFitnessPal')")
    source_id = models.CharField(max_length=255, help_text="ID from the external source system", db_index=True)
    consumption_date = models.DateTimeField(help_text="When the food was consumed (local datetime)")
    calories = models.DecimalField(max_digits=7, decimal_places=2, help_text="Total calories consumed")
    ...
    abandoned = models.BooleanField(default=False, help_text="True if user stopped tracking nutrition for this day")

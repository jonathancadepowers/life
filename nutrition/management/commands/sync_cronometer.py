...
def _has_meaningful_data(day_data):
    ...
    return day_data["calories"] != 0 or day_data["fat"] != 0 or day_data["carbs"] != 0 or day_data["protein"] != 0
...
class Command(BaseSyncCommand):
    ...
    def sync(self, days, sync_all=False):
        ...
        try:
            ...
            return self.make_error_result("Cronometer CLI not built - see logs for build instructions")
    ...
    def _process_day_data(self, day_data, user_tz):
        ...
        try:
            ...
            self.stdout.write(self.style.WARNING(f"Skipping invalid date {date_str}: {e}"))
            return "skipped"
